...
*   **Self-Contained**: All project files are strictly within `/Users/jonathonmarsden/projects/council-news-bot/`.
*   **Path Sanitization**: Removed hardcoded absolute paths (e.g., `/Users/jonathonmarsden/Projects/...`) from `scripts/`.
*   **Credential Safety**: 
