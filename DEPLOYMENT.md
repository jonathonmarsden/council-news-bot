...
ssh root@170.64.186.16 'cd /opt/council-news-bot && docker compose exec -T bot python3 main.py --state vic --limit 1 --dry-run'
...
ssh root@170.64.186.16 'cd /opt/council-news-bot && docker compose exec -T bot python3 main.py --state nt --limit 1 2>&1 | grep -i "discord\|webhook\|summary"'
