...
ssh root@170.64.186.16 "cd /opt/council-news-bot && docker compose exec -T db psql -U councilbot council_news -c 'SELECT COUNT(*) FROM log_events; SELECT COUNT(*) FROM run_summaries;'"

# View recent cron logs
ssh root@170.64.186.16 "tail -50 /var/log/council_bot_cron.log"

# Check next hourly briefing time
ssh root@170.64.186.16 "crontab -l | grep hourly_briefing"
```
