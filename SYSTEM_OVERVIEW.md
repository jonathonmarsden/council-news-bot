...
**Status:** Production (vps.example.com)  
...
```
VPS: vps.example.com (DigitalOcean)
├─ Docker Compose
...
# Database backup
ssh root@vps.example.com "cd /opt/council-news-bot && docker compose exec db pg_dump -U councilbot council_news > backup.sql"
```
...
# Proxy
PROXY_URL=http://REDACTED-rotate:***@proxy.example.com:80
