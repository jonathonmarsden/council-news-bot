...
REMOTE_SCRIPT_PATH = "/opt/council-news-bot/scripts/maintenance/fix_warren_db.py"
LOCAL_SCRIPT_PATH = "scripts/maintenance/fix_warren_db.py"
...
def main():
    ...
    # 2. Run script
    print("\nRunning fix script on VPS...")
    run_command_with_pty(f"ssh {USER}@{HOST} 'cd /opt/council-news-bot && python3 scripts/maintenance/fix_warren_db.py'", PASS)
