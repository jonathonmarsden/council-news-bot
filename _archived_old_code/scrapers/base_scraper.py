...
class BaseScraper(ABC):
    ...
    def __init__(self, council_id: str, council_name: str, news_url: str, use_curl: bool = False, mobile_mode: bool = False):
        """
    ...
    def _fetch_with_curl(self, url: str) -> Optional[str]:
        ...
        print(f"DEBUG: Fetching with curl: {url}")
        try:
    ...
    def parse_date(self, date_str: str) -> Optional[datetime]:
        ...
        date_str = re.sub(r'^(Published|Updated|Posted|Last updated)( on)?\s*', '', date_str, flags=re.IGNORECASE)
...
class CardScraper(BaseScraper):
    ...
    def __init__(self, council_id: str, council_name: str, news_url: str, use_curl: bool = False, mobile_mode: bool = False, selectors: Optional[Dict[str, str]] = None):
        super().__init__(council_id, council_name, news_url, use_curl, mobile_mode)
    ...
    def scrape(self) -> List[NewsArticle]:
        ...
        article_selector = self.selectors.get('item_selector', self.ARTICLE_SELECTOR)
